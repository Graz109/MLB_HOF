This repo contains an Ipython notebook that contains a personal project I did attempting to predict
if a given pitcher will be inducted into the MLB Hall of Fame.

The scope of the project is currently focused distinugishing between "good" players and "great" players. 
